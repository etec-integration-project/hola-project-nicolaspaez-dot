...
def generate_wiki_content(wiki_dir: Path, data_dir: Path):
    ...
    try:
        ...
        with open(wiki_dir / 'Home.md', 'w', encoding='utf-8') as f:
            f.write("""# UM Tesorería Report Service

Bienvenido a la Wiki del Servicio de Reportes de UM Tesorería.

## Propósito

El Servicio de Reportes es el componente encargado de la generación y gestión de documentos PDF, facturas electrónicas y otros reportes para la infraestructura de UM Tesorería.
...
""")
        ...
        with open(wiki_dir / 'Milestones.md', 'w', encoding='utf-8') as f:
            f.write("# Milestones del Servicio de Reportes\n\n")
        ...
        with open(wiki_dir / 'Issues-Activos.md', 'w', encoding='utf-8') as f:
            f.write("# Issues Activos - Servicio de Reportes\n\n")
        ...
        with open(wiki_dir / 'Issues-Cerrados.md', 'w', encoding='utf-8') as f:
            f.write("# Issues Cerrados - Servicio de Reportes\n\n")
        ...
        print(f"Error escribiendo archivos de la wiki del Servicio de Reportes: {e}")
        return False
